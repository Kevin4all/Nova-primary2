...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="es">
  <head>
    ...
    <title><?= $nombre_pestania?> - Administración</title>
    <link
    ...
    />
    <link rel="stylesheet" type="text/css" href="<?= base_url('recursos_panel/vendors/styles/style.css');?>">
    <script
              ...
              <li class="relative">
                ...
                >
                  <img
                    ...
                    src="<?= base_url('Imagenes/perfil.png')?>"
                    alt=""
                    aria-hidden="true"
                  />
                </button>
