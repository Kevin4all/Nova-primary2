...
<h2
            ...
            <?php
            $parametros = array('id' => 'formulario-asignacion-detalles'
                                );
            echo form_open_multipart(route_to('editar_asignacion'), $parametros);
        ?>
        ...
        <label class="block text-sm">
                ...
                <?php
                            ...
                            echo form_dropdown('materia',$materias, $materia_periodo->id_materia, $parametros);
                            
                            $parametros = array('type' => 'hidden',
                                                'id' => 'id_materia_periodo',
                                                'name' => 'id_materia_periodo',
                                                'value' => $materia_periodo->id_materia_periodo
                                                );
              ...
              <label class="block text-sm">
                ...
                <?php
                            ...
                            echo form_dropdown('periodo', $periodos, $materia_periodo->id_periodo, $parametros);
                        ?>
              </label>
                                            </div>
                                            <div class="mt-4 text-sm">
