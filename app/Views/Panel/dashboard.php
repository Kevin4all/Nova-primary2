        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?= base_url('recursos_panel/public/charts.html')?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
            ...
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?= base_url('recursos_panel/public/modals.html')?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
            ...
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?= base_url('recursos_panel/public/tables.html')?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="<?= base_url('recursos_panel/public/pages/login.html')?>">Login</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="<?= base_url('recursos_panel/public/pages/create-account.html')?>">
                      Create account
                    </a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="<?= base_url('recursos_panel/public/pages/forgot-password.html')?>">
                      Forgot password
                    </a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="<?= base_url('recursos_panel/public/pages/404.html')?>">404</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="<?= base_url('recursos_panel/public/pages/blank.html')?>">Blank</a>
                  </li>
                </ul>
              </template>
            </li>
